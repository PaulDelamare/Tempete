                    ...
                    {filteredAreas.map((area) => (
                        ...
                        >
                            <div className="flex flex-col items-center">
                                <div className="bg-red-500 w-8 h-8 rounded-full border-2 border-white cursor-pointer hover:bg-red-600"></div>
                                {currentZoom >= 14 && (
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-700 mt-1">
                                            <div>
                                                Longitude:{" "}
                                                {selectedArea.longitude.toFixed(
                                                    6
                                                )}
                                            </div>
                                            <div>
                                                Latitude:{" "}
                                                {selectedArea.latitude.toFixed(
                                                    6
                                                )}
                                            </div>
                                        </div>
