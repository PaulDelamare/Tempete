...
export const MapControls: React.FC<MapControlsProps> = ({
    ...
    return (
        <div className="absolute top-4 right-4 z-10 flex flex-col sm:flex-row gap-2 items-start">
            {/* Filtre par type */}
            <div className="relative">
                            ...
                            className="pl-10 pr-8 py-2 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black text-white shadow-lg text-sm cursor-pointer w-64 sm:w-auto sm:min-w-[140px]"
                        >
                ...
                <div className="absolute left-2 top-1/2 transform -translate-y-1/2 pointer-events-none">
                    {selectedType === "all" ? (
                        ...
                        <div className="absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none">
                            <svg className={`w-4 h-4 text-gray-300 transition-transform ${isSelectOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {isSelectOpen && (
                            <div
                                ...
                                className="absolute top-full left-0 right-0 mt-1 bg-black border border-gray-600 rounded-lg shadow-lg z-20 max-h-60 overflow-y-auto"
                            >
                        ...
                        <div
                            onClick={() => {
                                ...
                                setIsSelectOpen(false);
                                                            ...
                                                            className={`flex items-center gap-3 px-3 py-2 cursor-pointer hover:bg-gray-800 text-white ${selectedType === "all" ? "bg-blue-600/20" : ""}`}
                        >
                            ...
                            <div
                                ...
                                onClick={() => {
                                    ...
                                    setIsSelectOpen(false);
                                                                        ...
                                                                        className={`flex items-center gap-3 px-3 py-2 cursor-pointer hover:bg-gray-800 text-white ${selectedType === type ? "bg-blue-600/20" : ""}`}
                            >
            ...
            <div className="relative">
                        ...
                        className="px-4 py-2 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-64 bg-black text-white placeholder-gray-400 shadow-lg"
                    />
                {searchTerm && (
                    <button
